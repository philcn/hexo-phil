...
Hexo.prototype._bindLocals = function() {
  ...
  // since we filtered out all unlisted posts in locals.posts, in order to generate and create route for unlisted posts we need to create a new entry called unlisted, to be consumed by the unlisted generator.
  locals.set('unlisted', function(){
    var query = {};
